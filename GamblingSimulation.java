...
public class GamblingSimulation {
    ...
    public static void main(String[] arg) {
        ...
        {
            System.out.println("Total amount won in 20 days = " + totalAmountForDay);
        } 
        else if (totalAmountForDay == 0) 
        {
            System.out.println("No net gain or loss in 20 days");
        } 
        else 
        {
            System.out.println("Total amount lost in last 20 days = " + Math.abs(totalAmountForDay));
        }
        ...
        for(int j=1; j<=30;j++) {
            if (dailyAmount > 0)
            {
                System.out.println("Amount won on day " + j + " = $" + dailyAmount);
            } 
            else if (dailyAmount == 0)
            {
                System.out.println("No net gain or loss on day " + j);
            } 
            else 
            {
                System.out.println("Amount lost on thatday " + j + " = $" + Math.abs(dailyAmount));
            }
        }
    }
}
